...
use App\Models\Review; // <-- Cần import Review Model (nếu có)
...
// use Illuminate\Support\Facades\Validator; // Nếu dùng Validator facade
// use App\Http\Requests\StoreProductRequest; // Ví dụ dùng Form Request
// use App\Http\Requests\UpdateProductRequest; // Ví dụ dùng Form Request
...
class ProductController extends Controller
{
    ...
    $query->whereIn('brand_id', $request->input('brand'));
     ...
     $query->whereIn('type_id', $request->input('type'));
        ...
        $allowedSortColumns = ['id', 'price', 'rating', 'name', 'created_at', 'updated_at'];
